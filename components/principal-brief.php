<div class="homepage-principal-brief">
    <div class="col-md-6 homepage-principal-brief-left">
        ...
        <div class="homepage-principle-brief-content">
            ...
            <a href="#" class="read-more-btn-sm">Read More</a>
        </div>
    </div>
</div>

<div class="d-flex mb-5">
    <a href="#" class="col-md-2 home-page-under-button-extreme-left">Principal</a>
    <a href="#" class="col-md-2 home-page-under-button-left">Founders</a>
    <a href="#" class="col-md-2 home-page-under-button-right">Director</a>
</div>